...
public class RxExchange
{
    ...
    private void updateMarketDataFeed()
    {
        ...
        MarketDataSnapshot marketDataSnapshot = new MarketDataSnapshot(highestBid(), lowestAsk());
        marketDataFeed.onNext(marketDataSnapshot);
    }
        ...
        final Order order, final Side side, final Order other)
    {
        ...
        ExecutionReport executionReport = new ExecutionReport(ask.getPrice(), bid.getParty(), ask.getParty());
